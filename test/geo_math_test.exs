defmodule GeoMathTest do
  ...
  test "calculates distance Boulder to Walleroo" do
    assert_in_delta(GeoMath.distance(boulder_colorado(), wallaroo_australia()),
      5517, 1)
  end

  test "calculates distance LAX to JFK" do
    assert_in_delta(GeoMath.distance(lax(), jfk(), GeoMath.nm_radius()),
      2145, 1)
  end

  test "calculates initial bearing Boulder to Walleroo" do
    assert_in_delta(GeoMath.bearing(boulder_colorado(), wallaroo_australia()),
      153, 1)
  end
